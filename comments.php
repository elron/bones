...
<section id="respond" class="respond-form">
	...
	<ul id="comment-form-elements" class="clearfix">
		...
		<li>
		  <label for="author"><?php _e("Name", "bonestheme"); ?> <?php if ($req) _e("(required)", "bonestheme"); ?></label>
		...
		<li>
		  <label for="email"><?php _e("Mail", "bonestheme"); ?> <?php if ($req) _e("(required)", "bonestheme"); ?></label>
